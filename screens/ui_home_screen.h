...
extern lv_obj_t *ui_drawer_open;
extern lv_obj_t *ui_learningAddcard2;
extern lv_obj_t *ui_drawer_opened;
extern lv_obj_t *ui_drawer_opening;
extern lv_obj_t *ui_drawer_closing;
// CUSTOM VARIABLES
