...
lv_obj_t *uic_drawer;
lv_obj_t *ui_drawer = NULL;lv_obj_t *ui_drawerOpen = NULL;lv_obj_t *ui_learningAddcard = NULL;lv_obj_t *ui_drawerOpenImage = NULL;lv_obj_t *ui_draweropening = NULL;lv_obj_t *ui_drawerclosing = NULL;
// event funtions

// build funtions

void ui_drawer_screen_init(void)
{
ui_drawer = lv_obj_create(NULL);
lv_obj_remove_flag( ui_drawer, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_drawerOpen = lv_image_create(ui_drawer);
...
ui_learningAddcard = lv_image_create(ui_drawer);
...
ui_drawerOpenImage = lv_image_create(ui_drawer);
...
ui_draweropening = lv_image_create(ui_drawer);
...
ui_drawerclosing = lv_image_create(ui_drawer);
...
uic_drawer = ui_drawer;

}

void ui_drawer_screen_destroy(void)
{
   if (ui_drawer) lv_obj_del(ui_drawer);
