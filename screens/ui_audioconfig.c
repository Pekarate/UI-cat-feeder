...
lv_obj_t *ui_audioconfig = NULL;lv_obj_t *ui_Panel4 = NULL;lv_obj_t *ui_settingLabel1 = NULL;lv_obj_t *ui_iconImage1 = NULL;lv_obj_t *ui_okLabel1 = NULL;lv_obj_t *ui_boxImage1 = NULL;lv_obj_t *ui_backLabel1 = NULL;lv_obj_t *ui_btnVolume = NULL;lv_obj_t *ui_scheduleLabel1 = NULL;lv_obj_t *ui_btnRecord = NULL;lv_obj_t *ui_audioLabel1 = NULL;lv_obj_t *ui_ImageAudio1 = NULL;lv_obj_t *ui_btnBeep = NULL;lv_obj_t *ui_LabelTime1 = NULL;lv_obj_t *ui_btnPlay = NULL;lv_obj_t *ui_LabelInfo1 = NULL;lv_obj_t *ui_ImageInfo1 = NULL;lv_obj_t *ui_volumeLabel = NULL;lv_obj_t *ui_beepLabel = NULL;
// event funtions
